        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/products/bestsellers" className="text-sm text-muted-foreground hover:text-foreground">
                  Best Sellers
                </Link>
              </li>
              <li>
                <Link href="/products/deals" className="text-sm text-muted-foreground hover:text-foreground">
                  Deals
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Globaloring. All rights reserved.
            </p>
